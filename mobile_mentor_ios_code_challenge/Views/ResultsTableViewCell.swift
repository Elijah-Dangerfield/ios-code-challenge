...
class ResultsTableViewCell: UITableViewCell {
    ...
    Constraints().constraintWithTopAndLeadingAnchor(field: containerView, width: UIElementSizes.windowWidth - (resultImageView.bounds.width + 50), height: 300, topAnchor: resultImageView.topAnchor, topConstant:  0, leadingAnchor: resultImageView.trailingAnchor, leadingConstant: 25)
        
    Constraints().constraintWithTopAndLeadingAnchor(field: albumTitleLabel, width: UIElementSizes.windowWidth - 150, height: 30, topAnchor: containerView.topAnchor, topConstant: 0, leadingAnchor: containerView.leadingAnchor, leadingConstant: 0)
        
    Constraints().constraintWithTopAndLeadingAnchor(field: artistTitleLabel, width: UIElementSizes.windowWidth - 150, height: 30, topAnchor: albumTitleLabel.bottomAnchor, topConstant: 0, leadingAnchor: containerView.leadingAnchor, leadingConstant: 0)
